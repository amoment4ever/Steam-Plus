...
export const overridSteaMinventoryLoad = () => {
    ...
    //     if (this.m_bFullyLoaded && this.GetCountTotalItems() > 75)
    ...
    //                         const description = data?.rgDescriptions[`${currentAsset.classid}_${currentAsset.instanceid}`]
    ...
    //                             "cache_expiration": description?.cache_expiration
    //                         }
    //                         total_inventory_count = currentAsset.pos;

    //                         if(!window.g_ActiveInventory?.m_rgAssets?.[currentAsset?.id]) {
    //                             assets.push(asset);
    //                         } else {
    //                             if(window.g_ActiveInventory?.m_rgAssets?.[currentAsset?.id]) {
    //                                 window.g_ActiveInventory.m_rgAssets[currentAsset.id].cache_expiration = description?.cache_expiration
    //                             }
    //                         }
    //                     });
    //                     let descriptions = [];
